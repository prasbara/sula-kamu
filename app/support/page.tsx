...
import SupportNivaFlow from '@/components/SupportNivaFlow';

export const metadata = {
  title: 'Support NIVA & Pusat Bantuan Resmi | NIVA Semarang',
  description: 'Dukung perkembangan infrastruktur dan operasional NIVA Semarang, atau ajukan tiket bantuan teknis dan keamanan kepada tim admin resmi.',
};
  ...
  return (
    <div className="min-h-screen bg-[#0F0D13] text-[#F3EDF7] flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-12 space-y-16">
        {/* Support NIVA Production Feature Flow */}
        <SupportNivaFlow />

        {/* Existing Unified Helpdesk & Ticketing Section */}
        <section id="helpdesk" className="border-t border-[#2B2438] pt-12 space-y-10">
          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#5B3A6D]/30 border border-[#5B3A6D]/60 text-xs font-semibold text-[#E8B4C8]">
              ...
              <span>Unified Safety & Helpdesk Center</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-display font-extrabold text-white tracking-tight">
              Pusat Bantuan & Kendala Layanan
            </h2>
            <p className="text-xs sm:text-sm text-[#C8BED4] leading-relaxed">
              Mengalami kendala teknis, laporan keamanan, kebutuhan verifikasi, atau pertanyaan akun? Gunakan jalur resmi bantuan NIVA di bawah ini.
            </p>
          </div>
